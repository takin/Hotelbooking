...
function printdiv(printpage)
{
   ...
   img_url = "http://"+window.location.host+"/images/map-marker.png";
   ...
   $('#map_canvas').css({display:'none',width :'',height :''});
   $('#static_map').css({display:'block',width :'800',height :'350'});	
   ...
   var html="<html>";
   	html+= document.getElementById(printpage).innerHTML;
   	html+="</html>";
    printpage.css.css("display","block");

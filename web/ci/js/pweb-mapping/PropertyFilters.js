...
*/	
    ...
    pweb_filter.addFilterMap('city', 'city_side_map_container', 'en', data.city_info.city_geo_lat, data.city_info.city_geo_lng);
//    pweb_filter.addFilterMap('city_side_map', 'city_side_map_container', 'en', data.city_info.city_geo_lat, data.city_info.city_geo_lng);
...
//    });
        ...
        // open the map after page finishes load
        pweb_filter.toggleMap('city');

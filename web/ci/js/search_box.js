    ...
    countryId,cityId,dateId,nightsId, currencyId, searchId)
{
    ...
    // variable nocountryval and nocityval are defined in header.php file
    /// web/wp/wp-content/themes/Auberge/header.php
    else if($('#'+countryId+' :selected').val() == countryEmptyVal ||
        $('#'+countryId+' :selected').val() == nocountryval ||

...
{var landmarklatlng=$("#divLandmark_"+property_number+" input:radio:checked").val();alert('landmarklatlng='+landmarklatlng);this.changeLandmarkLayer(landmarklatlng);}
else

...
{modify_searchShowHide();}});function modify_searchShowHide(){$('#side_search_wrap').toggle();$(this).toggleClass('expand');$(this).toggleClass('collapse');if($(this).hasClass('expand'))

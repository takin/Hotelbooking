...
if(search_custom.value!=search_custom.defaultValue){}
$("#search-city").addClass('disabled');$("#search-country").addClass('disabled');}});$(".iframe").fancybox();if($("#property_list").length>0)
{modify_searchShowHide();}
function modify_searchShowHide(){$('#side_search_wrap').toggle();$(this).toggleClass('expand');$(this).toggleClass('collapse');if($(this).hasClass('expand'))
{$('#side_search_wrap_city').show();$('#side_search_wrap').show();}
else
{$('#side_search_wrap_city').hide();$('#side_search_wrap').hide();}
return false;}});function startslideshow(){var main_pic=$('.main-pic');if(main_pic.length){main_pic.cycle({fx:'fade',timeout:7000});}}

...
<?php get_sidebar(); ?>
	<div id="main" class="grid_12">
		...
		<?php if(!get_thumb_url($post->ID)==''){?>
								<a title="<?php the_title();?>" href="<?php the_permalink(); ?>"><img width="192" height="152" alt="<?php the_title();?>" src="<?php echo get_bloginfo('template_url') .'/scripts/t.php?zc=1&amp;w=192&amp;h=152&amp;src='.get_thumb_url($post->ID);?>" /></a>
							 <?php }else{?>
								<a title="<?php the_title();?>" href="<?php the_permalink(); ?>"><img width="192" height="152" alt="<?php the_title();?>" src="<?php echo get_bloginfo('template_url') .'/scripts/t.php?zc=1&amp;w=192&amp;h=152&amp;src='.get_bloginfo('template_url').'/images/na.jpg';?>" /></a>
							 <?php }?>

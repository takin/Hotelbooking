...
<div class="box_content box_round group">
       <ul class="site-info">
         ...
         <li id="support" style="display:none;"><img src="'.$aj_api_url.'images/sideinfo-support.png" alt="" /><span>'.__('Un service clientèle de qualité disponible','auberge').' <b>'.__('24h/24, 7j/7','auberge').'</b> '.__('prêt à vous guider à tout moment.','auberge').'</span></li>
				 
				 <li id="support"><img src="'.$aj_api_url.'images/sideinfo-support.png" alt="" /><br><span>'.__('Text/SMS (Free)','auberge').'</span></li>
...
<div class="box_content box_round group">
       <ul class="site-info">
         ...
         <li id="support" style="display:none;"><img src="'.$aj_api_url.'images/sideinfo-support.png" alt="" /><span>'.__('Un service clientèle de qualité disponible','auberge').' <b>'.__('24h/24, 7j/7','auberge').'</b> '.__('prêt à vous guider à tout moment.','auberge').'</span></li>
				 ...
				 <li id="support"><img src="'.$aj_api_url.'images/hb-icons-cell.png" alt="" /><br><span>'.__('Text/SMS (Free)','auberge').'</span></li>

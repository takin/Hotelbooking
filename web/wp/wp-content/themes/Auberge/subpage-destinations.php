		...
		<div class="box_content box_round group list_box">
          ...
          <span class="article-cat"><?php
           ...
           ?></span>
				...
				<a title="<?php the_title();?>" href="<?php the_permalink(); ?>"><img class="alignleft" width="130" height="85" alt="<?php the_title();?>" src="<?php echo get_bloginfo('template_url') .'/scripts/timthumb.php?zc=1&amp;w=130&amp;h=85&amp;src='.get_thumb_url($post->ID);?>" /></a>

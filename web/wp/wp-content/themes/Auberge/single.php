        ...
        <div class="entry group" id="post-<?php the_ID(); ?>">
            <?php if(!in_category('top-auberges') ){?>           
             ...
             <?php if((!get_thumb_url($post->ID)=='') && (get_post_image($post->ID) =='')){?>
                <img class="alignleft" width="200" height="140" alt="<?php the_title();?>" src="<?php echo get_bloginfo('template_url') .'/scripts/timthumb.php?zc=1&amp;w=200&amp;h=140&amp;src='.get_thumb_url($post->ID);?>" />
            <?php }?>  

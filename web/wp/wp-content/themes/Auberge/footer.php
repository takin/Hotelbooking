...
if ($GLOBALS['print'] == 'nostyle') {
    ...
    ?>" href="<?php echo get_option('aj_api_url') ?><?php
                   _e(
                           'England/London', 'auberge');
    ?>"><?php _e('Londres', 'auberge'); ?></a>,
                    <a style="font-size:<?php echo rand(8, 16) ?>pt;" title="<?php
                   _e(
                           'Rome', 'auberge');
    ?>" href="<?php echo get_option('aj_api_url') ?><?php
    ...
    ?>" href="<?php
                   echo get_option(
                           'aj_api_url')
    ?><?php _e('Spain/Barcelona', 'auberge'); ?>"><?php
                   _e(
                           'Barcelone', 'auberge');
    ?></a>,
                    <a style="font-size:<?php echo rand(8, 16) ?>pt;" title="<?php
    ...
    ?>" href="<?php echo get_option('aj_api_url') ?><?php
                   _e(
                           'France/Paris', 'auberge');
    ?>"><?php _e('Paris', 'auberge'); ?></a>,
                    <a style="font-size:<?php echo rand(8, 16) ?>pt;" title="<?php
                   _e(
                           'Amsterdam', 'auberge');
    ?>" href="<?php
                   echo get_option(
                           'aj_api_url')
    ?><?php _e('Netherlands/Amsterdam/', 'auberge'); ?>"><?php
                   _e(
                           'Amsterdam', 'auberge');
    ?></a>,
                    <a style="font-size:<?php echo rand(8, 16) ?>pt;" title="<?php
    ...
    ?>" href="<?php echo get_option('aj_api_url') ?><?php
                   _e(
                           'Ireland/Dublin', 'auberge');
    ?>"><?php _e('Dublin', 'auberge'); ?></a>,
                    <a style="font-size:<?php echo rand(8, 16) ?>pt;" title="<?php
                   _e(
                           'Madrid', 'auberge');
    ?>" href="<?php echo get_option('aj_api_url') ?><?php
                   _e(
                           'Spain/Madrid', 'auberge');
    ?>"><?php _e('Madrid', 'auberge'); ?></a>,
                    <a style="font-size:<?php echo rand(8, 16) ?>pt;" title="<?php
                   _e(
                           'Prague', 'auberge');
    ?>" href="<?php echo get_option('aj_api_url') ?><?php
                   _e(
                           'Czech%20Republic/Prague/', 'auberge');
    ?>"><?php _e('Prague', 'auberge');
    ?></a>,
                    <a style="font-size:<?php echo rand(8, 16) ?>pt;" title="<?php
                    _e(
                            'Berlin', 'auberge');
    ?>" href="<?php echo get_option('aj_api_url') ?><?php
                   _e(
                           'Germany/Berlin', 'auberge');
    ?>"><?php _e('Berlin', 'auberge'); ?></a>,
                    <a style="font-size:<?php echo rand(8, 16) ?>pt;" title="<?php
                   _e(
                           'Venise', 'auberge');
    ?>" href="<?php echo get_option('aj_api_url') ?><?php
                   _e(
                           'Italy/Venice', 'auberge');
    ?>"><?php _e('Venise', 'auberge'); ?></a>,
                    <a style="font-size:<?php echo rand(8, 16) ?>pt;" title="<?php
                   _e(
                           'Florence', 'auberge');
    ?>" href="<?php
                   echo get_option(
                           'aj_api_url')
    ?><?php _e('Italy/Florence', 'auberge'); ?>"><?php
                   _e(
                           'Florence', 'auberge');
    ?></a>,
                    <a style="font-size:<?php echo rand(8, 16) ?>pt;" title="<?php
    ...
    ?>" href="<?php echo get_option('aj_api_url') ?><?php
                   _e(
                           'Austria/Vienna', 'auberge');
    ?>"><?php _e('Vienne', 'auberge'); ?></a>,
                    <a style="font-size:<?php echo rand(8, 16) ?>pt;" title="<?php
                   _e(
                           'Budapest', 'auberge');
    ?>" href="<?php
                   echo get_option(
                           'aj_api_url')
    ?><?php _e('Hungary/Budapest', 'auberge'); ?>"><?php
                   _e(
                           'Budapest', 'auberge');
    ?></a>,
                    <a style="font-size:<?php echo rand(8, 16) ?>pt;" title="<?php
    ...
    ?>" href="<?php
                   echo get_option(
                           'aj_api_url')
    ?><?php _e('USA/New%20York', 'auberge'); ?>"><?php
                   _e(
                           'New York', 'auberge');
    ?></a>,
                    <a style="font-size:<?php echo rand(8, 16) ?>pt;" title="<?php
    ...
    ?>" href="<?php
                   echo get_option(
                           'aj_api_url')
    ?><?php _e('Scotland/Edinburgh', 'auberge'); ?>"><?php
                   _e(
                           'Edimbourg', 'auberge');
    ?></a>,
                    <a style="font-size:<?php echo rand(8, 16) ?>pt;" title="<?php
    ...
    ?>" href="<?php
                   echo get_option(
                           'aj_api_url')
    ?><?php _e('Sweden/Stockholm/', 'auberge'); ?>"><?php
                   _e(
                           'Stockholm', 'auberge');
    ?></a>,
                    <a style="font-size:<?php echo rand(8, 16) ?>pt;" title="<?php
    ...
    ?>" href="<?php echo get_option('aj_api_url') ?><?php
                   _e(
                           'Germany/Munich', 'auberge');
    ?>"><?php _e('Munich', 'auberge'); ?></a>,
                    <a style="font-size:<?php echo rand(8, 16) ?>pt;" title="<?php
                   _e(
                           'Nice', 'auberge');
    ?>" href="<?php echo get_option('aj_api_url') ?><?php
                   _e(
                           'France/Nice', 'auberge');
    ?>"><?php _e('Nice', 'auberge'); ?></a>,
                    <a style="font-size:<?php echo rand(8, 16) ?>pt;" title="<?php
                   _e(
                           'Athenes', 'auberge');
    ?>" href="<?php echo get_option('aj_api_url') ?><?php
                   _e(
                           'Greece/Athens', 'auberge');
    ?>"><?php _e('Athenes', 'auberge'); ?></a>,
                    <a style="font-size:<?php echo rand(8, 16) ?>pt;" title="<?php
                   _e(
                           'Valence', 'auberge');
    ?>" href="<?php echo get_option('aj_api_url') ?><?php
    ...
    ?>" href="<?php echo get_option('aj_api_url') ?><?php
                   _e(
                           'Belgium/Brussels/', 'auberge');
    ?>"><?php _e('Bruxelles', 'auberge');
    ?></a>
                </p>
            </div>
            <div class="footer-block grid_4">
                ...
                <ul class="dots">
                    ...
                    <li class="first">
                        <a href="/"><?php _e("Accueil", 'auberge'); ?></a></li>

                    <li><a href="<?php echo get_option('aj_api_search'); ?>">
                            <?php _e('Auberges et logements pas chers', 'auberge'); ?></a>
                    </li>
                    <?php if (get_option('aj_group_url') != '') { ?>
                        <li>
                            <a title="<?php _e("Réservation d'auberges de jeunesse pour les groupes", "auberge"); ?>" 
                               href="<?php echo get_option('aj_group_url'); ?>">
                                   <?php _e('Groupes 10+', 'auberge'); ?>
                            </a></li>
                    <?php } ?>

                    <?php if (get_option('aj_page_events') != '') { ?>
                        <li><a href="<?php echo get_option('aj_page_events'); ?>">
                                <?php _e('Événements', 'auberge'); ?>
                            </a></li>
                    <?php } ?>

                    <?php if (get_option('aj_page_guides') != '') { ?>
                        <li><a href="<?php echo get_option('aj_page_guides'); ?>">
                                <?php _e('Destinations', 'auberge'); ?>
                            </a> </li>
                    <?php } ?>
            ...
            <div class="footer-block grid_3">
                ...
                <ul class="dots">
                    <li><a href="<?php echo get_option('aj_page_faq'); ?>"><?php
                _e(
                        'Aide / FAQ / Nous Joindre', 'auberge');
                    ?></a></li>
                    <li><a href="<?php echo get_option('aj_page_conf'); ?>"><?php
                        _e(
                                'Confidentialité', 'auberge');
                    ?></a></li>
                    <li><a href="<?php echo get_option('aj_page_cond'); ?>"><?php
                        _e(
                                'Conditions', 'auberge');
                    ?></a></li>
                    <?php
                    $about = get_option('aj_page_about');
                    if (!empty($about)) {
                        ?><li><a href="<?php echo $about; ?>"><?php
                        _e(
                                'About us', 'auberge');
                        ?></a></li><?php } ?>
                </ul>

...
if(! defined('MAX_FILE_SIZE') )				define ('MAX_FILE_SIZE', 10971520);						// 20 Megs is 10485760. This is the max internal or external file size that we'll process.
...
if(! defined('NOT_FOUND_IMAGE') )		define ('NOT_FOUND_IMAGE', 'blank.gif');					// Image to serve if any 404 occurs
if(! defined('ERROR_IMAGE') )			define ('ERROR_IMAGE', 'blank.gif');						// Image to serve if an error occurs instead of showing error message
...
class timthumb {
	...
	protected function getLocalImagePath($src){
	    $this->debug(3, "DocRoot: " . $this->docRoot);
		if (ISWINDOWS) $src = "/wp".$src;
	    $this->debug(3, "Src: " . $src);

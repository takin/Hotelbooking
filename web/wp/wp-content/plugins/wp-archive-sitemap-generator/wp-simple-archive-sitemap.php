...
function wp_archive_sitemap_generator($text) {
	...
	if (preg_match("|<!--wp-archive-sitemap-generator-->|", $text)) {
		...
		{
			$sponsor_link1 = '<font size="1"><br/><i> Generated by: <a href="http://wordpress.org/extend/plugins/wp-archive-sitemap-generator/" target="_blank">WP Archive-Sitemap Generator</a></i></font>';
		}

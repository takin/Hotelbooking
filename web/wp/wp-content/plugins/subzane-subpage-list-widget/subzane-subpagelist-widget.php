...
function SZSubPageListWidget($args, $widget_args = 1) {
	...
	$pages = get_pages('hierarchical=1&exclude='.$exclude.'&parent='.$parent.'&child_of='.$parent);
	
	echo $before_widget;
	echo $before_title . $title . $after_title;
	echo '<form id="dropdownpage" action="">';
	echo '<select id="dropmenu" onchange="MM_jumpMenu(\'parent\',this,0)">';
	echo '<option value="">Choisir un guide -------------</option>';

...
class CI_DB_mysqli_driver extends CI_DB {
  ...
  function db_connect()
  {
    ...
    else
    {
      ...
      //print file_get_contents($this->ssl_key);

      //echo "read:". is_readable($this->ssl_ca);
      //echo "<br>";
      mysqli_ssl_set($init, $this->ssl_key, $this->ssl_cert, $this->ssl_ca, NULL, NULL);
      if (!empty($this->port))
      {

...
/*
|--------------------------------------------------------------------------
| User define Assets Groups
|--------------------------------------------------------------------------
*/
$config['groups']['formvalidation'] = array(

	'js' => array(
		array('livevalidation_standalone.js', 'livevalidation_standalone.compressed.js', TRUE, TRUE)
	)
);
/*--------------------------------------
| Full site Assets groups
|---------------------------------------
*/
//Scripts related to search box
$config['groups']['search_box_scripts'] = array(

	'js' => array(
		array('search_box.js'),
		array('mobile/suggest.js'),
		array('date-lib.js')
	)
);

/*--------------------------------------
| Full site HB Assets groups
|---------------------------------------
*/
//Scripts related to booking
$config['groups']['hb_booking'] = array(
...
/*--------------------------------------
| Mobile site Assets groups
|---------------------------------------
*/
//Scripts related to mobile main site
$config['groups']['mobile_main_site'] = array(
//  'js' => array(
//		array('mobile/iphone-style-checkboxes.js')
//	),
	'css' => array(
		array('mobile/main.css')
	)
);
//Scripts related to mobile city property list
$config['groups']['mobile_main_menu'] = array(

	'js' => array(
		array('mobile/tools.js')
	)
);

//Scripts related to mobile city property list
$config['groups']['mobile_city_property_list'] = array(

	'js' => array(
		array('mobile/sort.js')
	)
);
//Scripts related to mobile fancy box

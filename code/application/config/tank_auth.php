...
|--------------------------------------------------------------------------
| NOTE: Not used anymore. Replaced by site configs files.
*/
//$config['website_name'] = 'AubergesDeJeunesse.com';
//$config['webmaster_email'] = 'admin@aubergesdejeunesse.com';
...
$config['user_choose_pass_on_registration'] = FALSE;
$config['generate_password_length'] = 8;

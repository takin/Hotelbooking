...
|
*/
// Name has been changed to fix an issue while setting the wordpress db, made a mistake where we put the opposite with pt and br
$config['wp_db_tag'] = "wpblog_pt";
/*
|--------------------------------------------------------------------------
...
|
*/
$config['email_users_admin'] = "info@alberguesdajuventude.com";
/*
|--------------------------------------------------------------------------
...
|
*/
$config['contact_info_email'] = "info@alberguesdajuventude.com";
/*
|--------------------------------------------------------------------------
...
|
*/
$config['admin_booking_email'] = "info@alberguesdajuventude.com";
/*
|--------------------------------------------------------------------------
...
|
*/
$config['admin_booking_conf_email'] = "info@alberguesdajuventude.com";
/*
|--------------------------------------------------------------------------
...
|
*/
$config['admin_review_conf_email'] = "info@alberguesdajuventude.com";
/*
|--------------------------------------------------------------------------
...
|
*/
$config['site_currency_default'] = "USD";
/*
|--------------------------------------------------------------------------

...
|
*/
$config['base_url']	= "http://www.auberges.com/";

/*
|--------------------------------------------------------------------------
| Secure Base Site URL
|--------------------------------------------------------------------------
| Extension of CodeIgniter.
|
| If needed secure URL to redirect:
|
| https://example.com/
|
| Note: This might be overwritten in the main controller.
|
*/
$config['secure_base_url'] = 'https://www.auberges.com/';
...
|
*/
$config['encryption_key'] = 'znx683wA2H%tzWk';
...
|
*/
$config['sess_cookie_name']		= 'aj_session';
 ...
 */
$config["mostPopularFacilitiesById"] = array(

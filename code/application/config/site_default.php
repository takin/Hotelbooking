...
|
*/
//$config['site_title'] = "Auberges De Jeunesse";
/*
|--------------------------------------------------------------------------
| Site Name
|--------------------------------------------------------------------------
|
|  - Used in email address from field
|  - Used in sidebar (include/siteinfo.php)
|  - Used in user account pages
|
| Now, set via wordpress option.
|
*/
//$config['site_name'] = "AubergesDeJeunesse.com";
/*
|--------------------------------------------------------------------------
| Wordpress address
|--------------------------------------------------------------------------
|
| base URL of the wordpress
|
| Now, set via wordpress option.
|
*/
...
|
*/
$config['email_users_admin'] = "admin@aubergesdejeunesse.com";
/*
|--------------------------------------------------------------------------
...
|
*/
$config['contact_info_email'] = "info@aubergesdejeunesse.com";
/*
|--------------------------------------------------------------------------
...
|
*/
$config['admin_booking_email'] = "bookings@aubergesdejeunesse.com";
/*
|--------------------------------------------------------------------------
...
|
*/
$config['admin_booking_conf_email'] = "info@aubergesdejeunesse.com";
/*
|--------------------------------------------------------------------------

...
function utf8_specials_pattern() {
    ...
    if ( !$pattern ) {
        ...
        * @see utf8_specials_pattern
        *
        * Removed space char (0x0020)
        */
        $UTF8_SPECIAL_CHARS = array(
          0x001a, 0x001b, 0x001c, 0x001d, 0x001e, 0x001f, 0x0021, 0x0022, 0x0023,
 ...
 */
 ...
 function mb_stripAccent ( $title )
 {
   $search  = explode(",",'À,Á,Â,Ã,Ä,Å,Æ,Ç,È,É,Ê,Ë,Ì,Í,Î,Ï,Ð,Ñ,Ò,Ó,Ô,Õ,Ö,Ő,Ø,Ù,Ú,Û,Ü,ü,ű,ù,ú,û,ů,Ý,Þ,ß,à,á,â,ã,ä,å,æ,ç,è,é,ê,ë,ě,ę,ì,í,î,ï,ð,ñ,ò,ó,ô,õ,ö,ő,ø,ý,ý,þ,ÿ,Ŕ,Ř,ŕ,ř,й,Й,ň,ń,š,ś,ž,ż,ł,Ł,Ż,Ś,Š,Č,č,ť,ď');
   $replace = explode(",",'A,A,A,A,A,A,A,C,E,E,E,E,I,I,I,I,D,N,O,O,O,O,O,O,O,U,U,U,U,u,u,u,u,u,u,y,b,s,a,a,a,a,a,a,a,c,e,e,e,e,e,e,i,i,i,i,d,n,o,o,o,o,o,o,o,y,y,b,y,R,R,r,r,и,и,n,n,s,s,z,z,l,L,Z,S,S,C,c,t,d');
   return str_replace($search, $replace, $title);
 }

 function extract_int_of_str($string, $limit = 1)
 {
   $match = preg_match("/(\d+)/",$string, $number);

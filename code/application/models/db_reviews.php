...
class Db_reviews extends CI_Model {
    ...
    function add_property_review($email, $firstname, $lastname, $user_country, $property_number, $property_name, $property_city, $property_country, $property_type, $user_review, $user_rating, $date_visited, $user_IP, $user_agent) {
        ...
        $wpCommentID = $this->_wp_add_comment($this->_wp_get_option('aj_post_rating'), $firstname . ' ' . $lastname, $email, date('Y-m-d H:i:s'), $user_review, 0, $user_IP, $user_agent);
...
//      $this->_wp_add_comment_metadata($wpCommentID, "review_id", $reviewID );
    ...
    function _wp_add_comment($comment_post_ID, $comment_author, $comment_author_email, $comment_date, $comment_content, $comment_approved, $comment_author_IP, $comment_agent) {
        $data = array(

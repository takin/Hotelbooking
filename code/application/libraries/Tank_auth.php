...
class Tank_auth
{
	...
	function __construct()
	{
		...
		$this->ci->load->model('tank_auth/user_profiles');
	...
	function get_email()
	{
	  $user_data = $this->ci->users->get_user_by_id($this->ci->session->userdata('user_id'), TRUE);
   ...
   */
	function set_profile($user_id,$profile_data)
	{
	  return $this->ci->users->set_profile_data($user_id,$profile_data);
	}
	 /**
   ...
   */
	...
	{
	  return $this->ci->user_profiles->get_profile_data($user_id);
	}
}

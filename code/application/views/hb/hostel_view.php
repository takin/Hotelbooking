...
//                                die(var_dump($landmark, count($landmarks), $key, $landmarks));
			...
			?>
				<div class="save_to_favorites_options">
					...
					<a href="#" class="save_to_favorites" id="save_to_favorites_<?php echo $hostel["ID"]; ?>" style="vertical-align: middle;<?php echo $addToFav; ?>" title="<?php echo var_check($hostel["NAME"], ""); ?>">

...
<?php
	...
	echo $showForm
		? '<br /><h2><center>' . _('Existing account') . '</center></h2>'
		: '<h2><a href="#" onclick="$(\'#login_form_container\').show(); return false;"><center>' . _('Existing account') . '</center></a></h2>';
	echo $showForm
...
<?php } else { 
	echo '</div><h2><a onclick="SaveProperty.getRegisterForm(); return false;" href="', $this->Db_links->get_link("register"),'"><center>', _('Create account'), '</center></a></h2>';

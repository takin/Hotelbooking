...
<div class="box_content group box_round site-info-box">
	 <ul class="site-info">
		 ...
		 <li id="bestprice" style="display:none;"><img src="<?php echo site_url();?>images/sideinfo-10percent.png" alt="" /><span><?php echo _("Seulement 10% pour garantir votre réservation.");?></span></li>

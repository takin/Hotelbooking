    ...
    <div class="grid_4" id="sidebar">	
        ...
        <div class="box_content group box_round site-info-box">
            <ul class="site-info group">
                <?php
                if ($this->wordpress->get_option('aj_api_ascii') == "") {
                ...
                <li id="bestprice" style="display:none;"><img height="38px" src="<?php echo secure_site_url(); ?>images/sideinfo-10percent.png" alt="" /><span><?php echo _("Seulement 10% pour garantir votre réservation."); ?></span></li>
        ...
        <?php if ($api_error == false): ?>
            ...
            <?php else: ?>
                ...
                <form action="<?php echo secure_site_url(); ?>" method="post" onSubmit="booking_confirm('<?php echo secure_site_url(); ?>',false,'<?php echo $settleCurrency; ?>'); return false;">
                    <input type="hidden" id="api_shortname" name="api_shortname" value="hw" />
                    <div class="booking_section">  
                        <div class="popup-info-wrap">

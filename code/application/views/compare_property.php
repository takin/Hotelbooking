...
$a=$i+1;
 ...
 $maplink.='<td  class="control_button"><span class="link_color"><a href="javascript:void(0)">'._('See Map').'</a><span></td>';
...
<div class="quick_compare_scroll" id="quick_compare_scroll">
  ...
  <div class="logo_div"><img class="logo" src="<?php echo site_url().'images/'.$this->wordpress->get_option('aj_api_name').'/logo.png"';?> /></div>
  <br style="clear: both;">
